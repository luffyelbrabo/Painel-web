...
exit;
  ...
  echo -e 'Modificado por: @luffyelbrabo' >/usr/lib/telegram
  msg -bar
...
wget https://github.com/luffyelbrabo/Painel-web/raw/main/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/luffyelbrabo/Painel-web/raw/main/install/verifatt.sh > /dev/null 2>&1
wget https://github.com/luffyelbrabo/Painel-web/raw/main/install/verpweb > /dev/null 2>&1
wget https://github.com/luffyelbrabo/Painel-web/raw/main/install/verweb > /dev/null 2>&1
wget https://github.com/luffyelbrabo/Painel-web/raw/main/install/whatsapp.sh > /dev/null 2>&1
...
wget https://github.com/luffyelbrabo/Painel-web/raw/main/install/gestorssh.zip > /dev/null 2>&1
...
echo ""
echo -e "WEB LUFFY WEB" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mModificado por @luffyelbrabo\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "https://github.com/luffyelbrabo/Painel-web/raw/main/install/chave") &>/dev/null
...
echo -e "PAINEL WEB LUFFY WEB" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mModificado por @luffyelbrabo\033[1;36m" | lolcat
echo ""
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@luffyelbrabo\033[0m" | lolcat
echo ""
